...
public readonly struct Utf8Index : ISeekIndex<Utf8Index>
{
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) =>
        obj is Utf8Index other && Equals(this, other);

    /// <inheritdoc />
    public bool Equals(Utf8Index other) => Equals(this, other);
    ...
    /// </exception>
    public int CompareTo(Utf8Index other) => Compare(this, other);

    /// <inheritdoc />
    public static bool Equals(Utf8Index x, Utf8Index y) =>
        x.ByteIndex == y.ByteIndex && x.RuneIndex == y.RuneIndex;

    /// <inheritdoc />
    public static int Compare(Utf8Index x, Utf8Index y)
    {
        if (Equals(x, y))
        {
            return 0;
    ...
    /// <inheritdoc />
    public static bool operator ==(Utf8Index x, Utf8Index y) => Equals(x, y);

    /// <inheritdoc />
    public static bool operator !=(Utf8Index x, Utf8Index y) => !Equals(x, y);

    /// <inheritdoc />
    public static bool operator<(Utf8Index x, Utf8Index y) => Compare(x, y) < 0;
